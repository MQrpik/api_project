...
--
-- Host: 127.0.0.1
-- Czas generowania: 12 Lip 2021, 01:41
...
INSERT INTO `categories` (`id`, `category_name`, `created`, `view_order`) VALUES
(1, 'wielkopolskie', '2021-07-10', 1),
(2, 'mazowieckie', '2021-07-10', 2),
(4, 'małopolskie', '2021-07-11', 3),
(5, 'śląskie', '2021-07-11', 4);
...
INSERT INTO `entries` (`id`, `category_id`, `company_name`, `url`, `address`, `description`, `created`) VALUES
(1, 1, 'Orlen', 'www.orlen.pl', 'ul. Chemików 7, 10-100 Płock', 'Prywatny folwark Daniela Obajtka', '2021-07-10'),
(7, 1, 'Żabka', 'www.zabka/pl', 'ul. Sezamkowa 14, 63-200 Poznaż', 'Pyszne hotdogi i otwarte w niedziele.', '2021-07-10'),
(8, 2, 'CD Projekt', 'www.cdp.pl', 'ul. Szaraków 14, 63-220 Poznań', 'Skończyli się na Wiedzminie 3', '2021-07-10');
...
('root', '[{\"db\":\"api\",\"table\":\"categories\"},{\"db\":\"api\",\"table\":\"entries\"}]');
...
('root', '2021-07-11 13:11:57', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pl\"}');
